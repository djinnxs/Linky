    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-indigo-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
          ...
          <button onClick={handleGoogleLogin} type="button" className="w-full py-2.5 border border-gray-300 rounded-xl hover:bg-gray-50 font-medium flex items-center justify-center gap-2 text-sm">
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center"><span className="bg-white px-3 text-xs text-gray-400">{l.auth.or}</span></div>
          </div>
